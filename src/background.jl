...
using TiffImages, Images, ImageFiltering, ImageMorphology

export average_illumination, illumination_correction, remove_outliers

"""
Calculate average illumination of image stack
# Arguments
- `tifs_stack`: stack of tif images
- `directory`: directory of tif images
- `channel`: channel to be used for illumination calculation
# Returns
- `illumination`: average illumination of image stack
"""
function average_illumination(tifs_stack; directory=data_dir, channel=1)
    MTP_all = [] 
    ...
    for tif in tifs_stack
        ...
        I = img[:,:,channel] .* 2^16 # convert to 16 bit # CHANGE TO 12 BIT !!!!!!!!!!!!!!!
...
"""
function remove_outliers(I;radius=15,threshold=20) # :::TO DO::: make radius and threshold adaptive and add input argument for threshold values
    ...
    outliers_high = I .> (median_filtered .* (1.2))
...
export fit_2d_gaussian, sample_gaussian, subtract_background
